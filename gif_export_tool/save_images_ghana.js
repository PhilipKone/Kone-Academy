...
(async () => {
    console.log('Starting Ghana static image export...');

    // Configuration
    const svgPath = path.resolve(__dirname, '../ghana_card.svg');
    const outputPng = path.resolve(__dirname, '../ghana_card.png');
    const outputJpg = path.resolve(__dirname, '../ghana_card.jpg');
    const width = 1600;
    const height = 900;
