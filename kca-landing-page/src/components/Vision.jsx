      ...
      <div className="vision-container glass-panel">
        ...
        <div className="vision-grid">
          ...
          <div className="vision-card">
            ...
            <p className="vision-text">
              Our mission is to empower the next generation of innovators and developers by providing world-class software training, education, and research opportunities through software resources that are accessible to all.
            </p>
          </div>
        </div>
